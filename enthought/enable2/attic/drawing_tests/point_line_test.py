...
class PointLineTestWindow(ApplicationWindow):
    ...
    def _create_empty_line(self):
        """ Create an empty PointLine. """
        
        line = PointLine(line_color = (0.0, 0.0, 0.2, 1.0))
...
def main():
    ...
    window = PointLineTestWindow( title = "Line Test" )
