...
# Simple drawing and filling test for wx Mac backend.  Does not exercise
# the font or text routines.

from enthought.kiva import Canvas
from enthought.kiva.backend_wx import CanvasWindow
...
class MyApp(wx.App):
    def OnInit(self):
        CanvasWindow(size=(500,500), canvas_class=TestCanvas)
        return 1
