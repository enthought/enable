...
namespace agg24
{
    ...
    private:
        agg24::dda_line_interpolator<14> r, g, b, a;
    };
    ...
    private:
        agg24::dda_line_interpolator<14> v,a;
    };
    ...
    private:
        ...
        typedef agg24::pod_bvector<color_point, 4> color_profile_type;
        typedef agg24::pod_array<color_type>       color_lut_type;
